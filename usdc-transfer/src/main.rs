...
async fn main() {
    ...
    let account1 = Keypair::from_base58_string(&std::fs::read_to_string("account2.json").unwrap());
    let account2 = Keypair::from_base58_string(&std::fs::read_to_string("account1.json").unwrap());
